...
//O evento no React funciona de forma diferente. Quando voce da o console.log, percebe que não é o mesmo elemento que o js normal. Ele traz a diferenca de algumas propriedades. O React padroniza o evento para que ele possa ser utilizado independente do browser que este estiver sendo usado.
//O evento retorna um objeto, o e.target traz as propriedades que esse elemento pode realizar e o console.dir(e.target).
//O evento acaba se modificando e anulando todas as suas configuracoes quando acaba a funcao. PAra anular isso utilizamos o:
e.persist()
//Ao inves disso, pode-se criar uma variavel target = e.target e atribui-la a outros 

//Ordem normal do React com eventos:
//evento = {}
//calback(evento)
//evento = null
